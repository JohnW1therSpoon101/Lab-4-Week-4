...
delFb.gain.value = 0; // feedback control
...
document.querySelector("#attTime").addEventListener("input", (e) => {
  document.querySelector("#attLabel").textContent = `${Number(
    e.target.value * 1000
  )} ms`;
...
document.querySelector("#decTime").addEventListener("input", (e) => {
  document.querySelector("#decLabel").textContent = `${Number(
    e.target.value * 1000
  )} ms`;
...
document.querySelector("#relTime").addEventListener("input", (e) => {
  document.querySelector("#relLabel").textContent = `${Number(
    e.target.value * 1000
  )} ms`;
...
document.querySelector("#fb").addEventListener("input", (e) => {
  document.querySelector("#fbLabel").textContent = `${Number(
    Math.round(e.target.value * 100)
  )}%`;
  delFb.gain.linearRampToValueAtTime(
    // smoothly adjust feedback gain
